package com.programming.kevin.apiGateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute() {
        return GatewayRouterFunctions.route("productService_swagger")
                .route(RequestPredicates.path("/aggregate/productService/v3/api-docs"), HandlerFunctions.http(productServiceUrl))
    ...
    public RouterFunction<ServerResponse> orderServiceSwaggerRoute() {
        return GatewayRouterFunctions.route("orderService_swagger")
                .route(RequestPredicates.path("/aggregate/orderService/v3/api-docs"), HandlerFunctions.http(orderServiceUrl))
    ...
    public RouterFunction<ServerResponse> inventoryServiceSwaggerRoute() {
        return GatewayRouterFunctions.route("inventoryService_swagger")
                .route(RequestPredicates.path("/aggregate/inventoryService/v3/api-docs"), HandlerFunctions.http(inventoryServiceUrl))
